...
namespace cowsins
{
    public class InteractManager : MonoBehaviour
    {
        ...
        [Tooltip("Attach your main camera"), SerializeField] protected Camera mainCamera; // Attach your main camera

        protected Transform orientation;

        protected PlayerMovement playerMovement;

        [Tooltip("Bitmask that defines the interactable layer"), SerializeField] protected LayerMask mask;

        protected Interactable highlightedInteractable;
        ...
        [Tooltip("Distance from the player to detect interactable objects"), SerializeField] protected float detectInteractionDistance;
        ...
        [Tooltip("Adjust the interaction interval, the lower, the faster you will be able to interact"), Range(.2f, .7f), SerializeField] protected float interactInterval = .4f;
        ...
        protected virtual void DetectPickeable()
        {
        ...
        protected virtual bool IsForbiddenInteraction(RaycastHit hit)
        {
        ...
        protected void EnableInteractionUI(Interactable interactable)
        {
        ...
        protected void DisableLookingAtInteractable()
        {
        ...
        protected void DisableInteractionUI()
        {
            DisableLookingAtInteractable();
