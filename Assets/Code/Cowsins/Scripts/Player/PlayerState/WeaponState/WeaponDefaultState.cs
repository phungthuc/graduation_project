...
namespace TheTunnel.Custom.cowsins
{
    ...
    public class WeaponDefaultState : WeaponBaseState
    {
        ...
        private PlayerConstruction playerConstruction;
        ...
        public override void EnterState()
        {
            ...
            playerConstruction = _ctx.GetComponent<PlayerConstruction>();
        ...
        public override void UpdateState()
        {
            ...
            if (playerConstruction.isBuilding)
            {
                if (InputManager.build && playerConstruction.CurrentSlotDetected != null)
                {
                    playerConstruction.Build();
                    InputManager.build = false;
                }
                return;
            }
            HandleInventory();
