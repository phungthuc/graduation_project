...
{
    public class CoverTargetDistanceSensor : LocalWorldSensorBase, IInjectable
    {
        ...
        public override SenseValue Sense(IMonoAgent agent, IComponentReference references)
        {
                ...
                ) > 0)
            {
                ...
                return new SenseValue(
                    Mathf.CeilToInt(Vector3.Distance(agent.transform.position, _targetPoint.position))
                );
            }
